...
Nämä ovat vahvoja uskomuksia, joista kaikki eivät ole samaa mieltä.
...
Tämä tuskin tyydyttää. Kaikkihan tietää, että koulutus ja tiede ovat tärkeitä asioita. Kai minulla nyt on jokin kiinnostavampi pointti?

Tässä välissä voisin puhua kuinka kaikki ei tiedä, "ilmiselvien" asioiden toistaminen on välillä hyvä ja uskomuksen totuudenmukaisuus ei ole sama asia kuin niiden kiinnostavuus, mutta annan asian olla. Kyllä, minulla *on* myös kiinnostavampaa sanottavaa, anteeksi, muita keskeisiä syitä uskomukselleni epin tärkeydestä.
...
Vastaan näin: Mitä käy, jos annan esimerkin, josta ihmiset ovat samaa mieltä kanssani? "Totta kai asia on noin, mutta tuon nyt pystyy näkemään ilman, että tarvitsee puhua epistä." Entä jos annan esimerkin, josta ihmiset ovat eri mieltä? "Jaa, tämä esimerkki ei vakuuta, näyttää siltä että sinä vain olet väärässä tästä asiasta. Sinä niin puhut hyvästä epistä, mutta itse uskot ihan hassuja juttuja."
...
Ja ongelmien ratkaisemiseksi auttaa, jos saamme vakuutettua muita. Ei nyt tietenkään *valehdella*, mutta esitetään sellaiset perustelut, joiden esittämisellä on parhaat seuraukset ja jolla saadaan muut puolellemme.
...
Nykyään minä uskon, että asialle *voi* tehdä jotakin. Vähintäänkin ihmiset (erityisesti ihmisaivot) [voidaan](https://waitbutwhy.com/2016/03/cryonics.html) *säilyttää* siihen asti, kunnes ihmiskunta on riittävän kehittynyt ratkaisemaan ongelman *kokonaan*.
